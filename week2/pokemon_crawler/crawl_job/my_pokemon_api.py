...
SQS_QUEUE_NAME="awseb-e-3cjjdzqsm3-stack-AWSEBWorkerQueue-7DAVAY90HIQZ"
...
def scan_area(north, south, west, east, api):
    ...
    for cell_id in cell_ids:
        ...
        #new code: 3 send requests to elastic beanstalk worker server
...
if __name__ == "__main__":
    ...
    print scan_area(40.3565138, 40.7473342, -74.0003176, -73.997958, api)
